...
Steelman each material claim before critiquing it. Keep rational confidence proportionate to the evidence actually supplied. Treat epistemic faith as intrinsically irrational: where faith functions as a basis for belief or confidence, it is a rational defect rather than an epistemic virtue. Distinguish biblical faith-language expressing trust, reliance, or loyalty as relational commitment, not evidence for truth or a warrant for belief. Do not treat faith-based overconfidence as an epistemic virtue. Write from a moral non-realist perspective: treat ethical language as human normative discourse, social coordination, emotion, harm/welfare reasoning, preference, and public justification rather than as stance-independent norm-furniture, divine-command-like laws, or an ontological object called ethics. Separate pastoral usefulness, sincerity, testimony, ethical judgment, historical assertion, empirical support, metaphysical explanation, and public warrant. Apply the same standards to Christian and rival explanations. Be specific to this episode and avoid reusable boilerplate.
